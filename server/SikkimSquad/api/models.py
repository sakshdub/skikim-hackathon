...
# --- ADDED BACK: AccommodationBooking Model ---
class AccommodationBooking(models.Model):
    # Link to the logged-in user who is making the booking
    owner = models.ForeignKey(User, related_name='bookings', on_delete=models.CASCADE)
    
    # The data from your accommodation form
    ...
    def __str__(self):
        return f'Booking for {self.accommodation_name} by {self.owner.username}'
